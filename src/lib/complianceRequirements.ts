...
export const DRIVER_REQUIREMENTS: readonly ComplianceRequirement[] = [
  ...
  },
  {
    ...
    driverVisible: true,
    driverActionable: true,
    helpText: 'The signed employment agreement with the carrier.',
    internalNotes: 'Required for Local (Ivan) and Box Truck drivers; Amazon drivers carry a lease agreement instead.',
  },
  {
    key: 'cdl_copy',
  ...
  },
  {
    ...
    driverActionable: true,
    helpText:
      'Download the W-9 form below, complete and sign it for your business or yourself, then upload the completed form.',
    links: [{ label: 'Download the W-9 form', url: 'https://drive.google.com/file/d/1Z7voKxDUMI90wcJAD5D-HTWjNb1qVUnE/view?usp=sharing' }],
  },
  {
...
export const AMAZON_REQUIREMENTS: readonly ComplianceRequirement[] = [
  ...
  },
  {
    ...
    label: 'Begin Amazon Relay training (HR)',
    category: 'Amazon Relay',
    appliesTo: ALL_DRIVERS,
    required: true,
    requiresDocument: false,
    ...
    driverVisible: false,
    driverActionable: false,
    helpText: 'Ivan Cartage HR starts the driver’s Amazon Relay training once truck setup and final steps are complete.',
    internalNotes: 'HR task — the final step of Phase 2. Mark complete once the driver has been kicked off to begin Amazon Relay training.',
  },
  {
  ...
  },
  {
    ...
    links: [{ label: 'Download the Direct Deposit Authorization form', url: 'https://drive.google.com/file/d/1xktqiw8Hv5cKV40agXE_awFIYmbBLZmY/view?usp=sharing' }],
  },
  {
